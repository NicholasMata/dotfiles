return {
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ts", builtin.builtin, { desc = "[s]elect telescope" })
			...
			vim.keymap.set("n", "<leader>tf", builtin.git_files, { desc = "[f]iles in git" })
			vim.keymap.set("n", "<leader>tg", builtin.live_grep, { desc = "by [g]rep" })
			vim.keymap.set("n", "<leader>tq", builtin.diagnostics, { desc = "[q]uickfix list" })
